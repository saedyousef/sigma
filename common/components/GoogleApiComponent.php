...
class GoogleApiComponent extends Component {
	...
	*/
	public function authenticateClient($code = null)
	{
		...
		if (isset($_SESSION['access_token']) && isset($_SESSION['expire_date']) && (date('Y-m-d H:i:s') < $_SESSION['expire_date'])) {
		...
		if(isset($_SESSION['expire_date']) && date('Y-m-d H:i:s') < $_SESSION['expire_date'])
			$_SESSION['expire_date'] = date("Y-m-d H:i:s", strtotime("+55 minutes"));
